...
class DbHelper
{
     ...
     * This function normalizes on the 3rd, merges in the default config settings for the column type, and renames
     * 'maxLength' to 'length'.
     *
     ...
     * @deprecated Deprecated in Craft 2.2. Use {@link DbCommand::addTablePrefix() craft()->db->addTablePrefix()}
     *             instead.
     ...
     * @deprecated Deprecated in Craft 2.2. Use {@link DbCommand::getForeignKeyName() craft()->db->getForeignKeyName()}
     *             instead.
     * @return string
     */
     ...
     * @param string       $table
     * @param string|array $columns
     * @deprecated Deprecated in Craft 2.2. Use {@link DbCommand::getPrimaryKeyName() craft()->db->getPrimaryKeyName()}
     *             instead.
     * @return string
     */
     ...
     *
     * @param string $name
     * @deprecated Deprecated in Craft 2.2. Use {@link DbCommand::trimObjectName() craft()->db->trimObjectName()}
     *             instead.
     * @return string
     */
