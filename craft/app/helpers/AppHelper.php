...
class AppHelper
{
    ...
    /**
     * Normalizes a version number based on the same logic as PHP’s
     * [version_compare](http://php.net/manual/en/function.version-compare.php) uses internally.
     *
     ...
     * Used by getPhpConfigValueInBytes() and getByteValueFromPhpSizeString() so long as we have to keep the latter
     * around.
     *
     * @param mixed $var
     * @return int
