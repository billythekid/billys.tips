...
class IOHelper
{
     ...
     *
     * @param string $path           The path to test.
     * @param bool   $fullPath       Whether to include the full path in the return results or the top level folder
     *                               only.
     * @param bool   $suppressErrors Whether to suppress any PHP Notices/Warnings/Errors (usually permissions related).
    ...
    /**
     * Will take a path, make sure the file exists and if the size of the file is 0 bytes, return true.  Otherwise
     * false.
     *
     * @param string $path           The path to test.
     * @param bool   $suppressErrors Whether to suppress any PHP Notices/Warnings/Errors (usually permissions related).
     ...
     * @param bool   $recursive      If the path is a folder, whether to change the owner of all of the folder's
     *                               children.
     * @param bool   $suppressErrors Whether to suppress any PHP Notices/Warnings/Errors (usually permissions related).
     ...
     * @param bool   $suppressErrors Whether to suppress any PHP Notices/Warnings/Errors (usually permissions related).
     * @return bool 'true' if the file was successfully cleared, 'false' if it wasn't, if the file is not writable or
    ...
    /**
     * Applies an array of filter rules to the string representing the file path. Used internally by {@link
     * dirContents}
     * method.
     *
     ...
     *                       with '/' is a regular expression. Any other string treated as an extension part of the
