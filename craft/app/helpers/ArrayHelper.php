...
class ArrayHelper
{
     ...
     *
     * @param array $arr
     * @return string|integer|null The first key, whether that is a number (if the array is numerically indexed) or a
     *                             string, or null if $arr isn’t an array, or is empty.
     */
