...
/**
 * The BaseElementsController class provides some common methods for {@link ElementsController} and {@link
 * ElementIndexController}. Note that all actions in the controller require an authenticated Craft session via {@link
 * BaseController::allowAnonymous}.
 *
