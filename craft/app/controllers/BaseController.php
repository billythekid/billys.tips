...
abstract class BaseController extends \CController
{
     ...
     *                       - `'expires'` - Sets the Expires header value (in seconds). Defaults to `false`, which
     *                       prevents the response from getting cached. If set to `null`, no Expires header will be
     *                       set.
     * @return null
     */
