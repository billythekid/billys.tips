 ...
 * By default, StatePersister stores data in a file named 'state.bin' that is located {@link
 * PathService::getStatePath()}. To retrieve the data from StatePersister, call {@link load()}. To save the data, call
 * {@link save()}. A comparison among state persister, session and cache is as follows:
