...
abstract class BaseMigration extends \CDbMigration
{
     ...
     *
     * @param string $table           The name of the table to be created. The name will be properly quoted by the
     *                                method.
     ...
     * @param bool   $includeAuditColumns Whether to include the data for the audit columns (dateCreated, dateUpdated,
     *                                    uid).
     * @return null
     */
