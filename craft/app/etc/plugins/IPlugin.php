...
interface IPlugin extends ISavableComponentType
{
     ...
     *         "notes": [
     *             "# Big Stuff",
     *             "[Added] It’s now possible to create new products right from Product Selector Modals (like the ones
     *             used by Products fields).",
     *             "[Improved] Variants are now defined in a new Variant Matrix field, right on the main Edit Product
     *             pages.",
     *             "# Bug Fixes",
     *             "[Fixed] Fixed a Twig error that occurred if you manually went to /commerce/orders/new. You now
     *             receive a 404 error instead."
     *         ]
     *     },
     *     {
     *         "version": "0.9.1",
     ...
     *         "notes": [
     *             "[Fixed] Fixed a PHP error that occurred when creating a new produt when the current user’s username
     *             was ‘null’."
     *         ]
     *     }
     * ]
     ...
     *   {@link http://php.net/manual/en/class.datetime.php#datetime.constants.iso8601 DateTime::ISO8601} (with or
     *   without the colon between the hours and minutes of the timezone offset).
