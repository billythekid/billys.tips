...
abstract class BaseModel extends \CModel
{
     ...
     * This is done by replacing underscores or dashes with blanks andchanging the first letter of each word to upper
     * case. For example, 'department_name' or 'DepartmentName' becomes 'Department Name'. Overriding CModel's
     * implementation to be UTF-8 friendly since they don't consider this a bug:
