...
class ElementsService extends BaseApplicationComponent
{
     ...
     * @param BaseElementModel[] $elements    The root element models that should be updated with the eager-loaded
     *                                        elements
     * @param string|array       $with        Dot-delimited paths of the elements that should be eager-loaded into the
     *                                        root elements
     * @return void
     */
     ...
     *                                            there’s no chance any elements are going to be found with the given
     *                                            parameters.
     */
     ...
     * @param bool             $asTask             Whether the element’s slug and URI should be updated via a
     *                                             background task.
     * @return null
     */
     ...
     * @param bool             $updateOtherLocales Whether the element’s other locales should also be updated.
     * @param bool             $asTask             Whether the descendants’ slugs and URIs should be updated via a
     *                                             background task.
     * @return null
     */
