...
class UsersService extends BaseApplicationComponent
{
     ...
     * @deprecated Deprecated in 2.3. Use {@link UsersService::updateUserLoginInfo()
     *             `craft()->users->updateUserLoginInfo()`} and {@link UserSessionService::storeSessionToken()
     *             `craft()->userSession->storeSessionToken()`} instead.
     */
