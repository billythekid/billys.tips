...
class CacheService extends BaseApplicationComponent
{
     ...
     *                                      have the value never expire, and `null` to use the ‘cacheDuration’ config
     *                                      setting.
     ...
     *                   (key,value) pairs. If a value is not cached or expired, the corresponding array value will be
     *                   false.
     */
