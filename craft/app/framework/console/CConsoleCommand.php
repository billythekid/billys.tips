 ...
 * }
 * </pre>
 * Since version 1.1.11 the return value of action methods will be used as application exit code if it is an integer
 * value.
 *
 * @property string                $name          The command name.
 * @property CConsoleCommandRunner $commandRunner The command runner instance.
 * @property string                $help          The command description. Defaults to 'Usage: php entry-script.php
 *           command-name'.
...
abstract class CConsoleCommand extends CComponent
{
     ...
     * @return integer application exit code, which is returned by the invoked action. 0 if the action did not return
     *                 anything.
     ...
     *                              The array keys are names displayed during the copy process, and array values are
     *                              specifications for files to be copied. Each array value must be an array of the
     *                              following structure:
     *                              <ul>
     ...
     *                              <li>callback: optional, the callback to be invoked when copying a file. The
     ...
     *                        Defaults to null, means that default string is disabled. This parameter is available
     ...
     *
     * @param string  $message to echo out before waiting for user input
     * @param boolean $default this value is returned if no selection is made. This parameter has been available since
     *                         version 1.1.11.
