...
class CConsoleCommandBehavior extends CBehavior
{
     ...
     * The default implementation returns 'onAfterConstruct', 'onBeforeValidate' and 'onAfterValidate' events and
     * handlers. If you override this method, make sure you merge the parent result to the return value.
     *
     ...
     * Override this method and make it public if you want to handle the corresponding event of the {@link
     * CBehavior::owner owner}.
     *
