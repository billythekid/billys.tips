...
class CConsoleCommandEvent extends CEvent
{
     ...
     * If this property is set true by the event handler, the console command action will quit after handling this
     * event. If false, which is the default, the normal execution cycles will continue, including performing the
     * action and calling
