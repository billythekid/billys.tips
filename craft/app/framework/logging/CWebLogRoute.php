...
class CWebLogRoute extends CLogRoute
{
     ...
     * For example if the Flash/Flex call expects an XML type result any output from the logger will cause Flash/Flex
     * call to fail.
     * @since 1.1.11
     */
     ...
     * Renders the view.
     *
     * @param string $view the view name (file name without extension). The file is assumed to be located under
