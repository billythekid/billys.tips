...
class CDbCache extends CCache
{
     ...
     * If you already have the table created, it is recommended you set this property to be false to improve
     * performance.
     * @see cacheTableName
     */
     ...
     *                       when storing a piece of data in the cache. Defaults to 100, meaning 0.01% chance.
     *                       This number should be between 0 and 1000000. A value 0 meaning no GC will be performed at
     *                       all.
     */
