...
/**
 * CWinCache implements a cache application component based on {@link http://www.iis.net/expand/wincacheforphp
 * WinCache}. To use this application component, the WinCache PHP extension must be loaded. See {@link CCache} manual
 * for common cache operations that are supported by CWinCache.
 *
 * @author  Alexander Makarov <sam@rmcreative.ru>
