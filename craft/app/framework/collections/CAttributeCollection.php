...
class CAttributeCollection extends CMap
{
     ...
     * This overrides the parent implementation by converting the key to lower case first if {@link caseSensitive} is
     * false.
     *
     ...
     * <li>if $a and $b both have an array indexed at the same string key, the arrays will be merged using this
     * algorithm;</li>
