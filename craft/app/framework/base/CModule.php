 ...
 * @property string               $basePath     The root directory of the module. Defaults to the directory containing
 *           the module class.
 * @property CAttributeCollection $params       The list of user-defined parameters.
 * @property string               $modulePath   The directory that contains the application modules. Defaults to the
 *           'modules' subdirectory of {@link basePath}.
 * @property CModule              $parentModule The parent module. Null if this module does not have a parent.
 * @property array                $modules      The configuration of the currently installed modules (module ID =>
 *           configuration).
...
abstract class CModule extends CComponent
{
     ...
     *
     * @return string the directory that contains the application modules. Defaults to the 'modules' subdirectory of
     *                {@link basePath}.
     */
     ...
     * @return IApplicationComponent the application component instance, null if the application component is disabled
     *                               or does not exist.
     * @see hasComponent
     */
     ...
     *                                               null, component will be unloaded from the module.
     ...
     *                                               registered component configuration with the same ID will be merged
     *                                               with the new configuration. If set to false, the existing
     *                                               configuration will be replaced completely. This parameter is
     ...
     *                            then all components specified in the configuration will be returned, whether they are
     *                            loaded or not. Loaded components will be returned as objects, while unloaded
     *                            components as configuration arrays. This parameter has been available since version
     *                            1.1.3.
     ...
     *                            Defaults to true, meaning the previously registered component configuration of the
     *                            same ID will be merged with the new configuration. If false, the existing
