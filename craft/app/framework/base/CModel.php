 ...
 * @property array        $errors             Errors for all attributes or the specified attribute. Empty array is
...
abstract class CModel extends CComponent implements IteratorAggregate, ArrayAccess
{
     ...
     *   will be applied in any scenario that is not listed in "except". Please see {@link scenario} for more details
     ...
     *                     Defaults to null, meaning all attributes as listed in {@link attributeNames} will be
     *                     returned. If it is an array, only the attributes in the array will be returned.
     ...
     *                          A safe attribute is one that is associated with a validation rule in the current {@link
     *                          scenario}.
