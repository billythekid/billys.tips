...
class CErrorHandler extends CApplicationComponent
{
    ...
    /**
     * @var string the application administrator information (could be a name or email link). It is displayed in error
     *      pages to end users. Defaults to 'the webmaster'.
     */
     ...
     * @return string the textual representation of the given error code or the replacement string if the error code is
     *                unknown
     */
