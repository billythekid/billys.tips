...
class CComponent
{
     ...
     *                         You can also pass an already created behavior instance (the new behavior will replace an
     *                         already created behavior with the same name, if it exists).
     ...
     * that can be directly accessed in the expression. See {@link http://us.php.net/manual/en/function.extract.php PHP
     * extract} for more details. In the expression, the component object can be accessed using $this. A PHP expression
     * can be any PHP code that has a value. To learn more about what an expression is, please refer to the {@link
