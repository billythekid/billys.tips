 ...
 * @property string            $runtimePath     The directory that stores runtime files. Defaults to
 *           'protected/runtime'.
 * @property string            $extensionPath   The directory that contains all extensions. Defaults to the
 *           'extensions' directory under 'protected'.
 * @property string            $language        The language that the user is using and the application should be
 *           targeted to. Defaults to the {@link sourceLanguage source language}.
 * @property string            $timeZone        The time zone used by this application.
 * @property CLocale           $locale          The locale instance.
 * @property string            $localeDataPath  The directory that contains the locale data. It defaults to
 *           'framework/i18n/data'.
...
abstract class CApplication extends CModule
{
     ...
     *
     * @return string the directory that contains all extensions. Defaults to the 'extensions' directory under
     *                'protected'.
     */
     ...
     * @param string $srcLanguage the language that the original file is in. If null, the application {@link
     *                            sourceLanguage source language} is used.
     * @param string $language    the desired language that the file should be localized to. If null, the {@link
     *                            getLanguage application language} will be used.
     ...
     *
     * @param string $localeID the locale ID (e.g. en_US). If null, the {@link getLanguage application language ID}
     *                         will be used.
     ...
     * @param mixed  $defaultValue the default value. If the named global value is not found, this will be returned
     *                             instead.
     ...
     * @param mixed  $defaultValue the default value. If the named global value is the same as this value, it will be
     *                             cleared from the current storage.
     * @see getGlobalState
     */
