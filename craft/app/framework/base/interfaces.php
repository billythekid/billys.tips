...
interface IUserIdentity
{
     ...
     *
     * @return array additional identity information that needs to be persistent during the user session (excluding
     *               {@link id}).
     */
...
interface IWidgetFactory
{
     ...
     * @param string          $className  the class name of the widget. This can also be a path alias (e.g.
