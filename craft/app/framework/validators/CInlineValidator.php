...
class CInlineValidator extends CValidator
{
    ...
    /**
     * Returns the JavaScript code needed to perform client-side validation by calling the {@link clientValidate}
     * method. In the client validation code, these variables are predefined:
     * <ul>
