...
class CEmailValidator extends CValidator
{
    ...
    /**
     * @var boolean whether to allow name in the email address (e.g. "Qiang Xue <qiang.xue@gmail.com>"). Defaults to
     *      false.
     * @see fullPattern
     */
     ...
     * This method is provided so that you can call it directly without going through the model validation rule
     * mechanism. Note that this method does not respect the {@link allowEmpty} property.
     *
