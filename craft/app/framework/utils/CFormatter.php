 ...
 * For convenience, CFormatter also implements the mechanism of calling formatting methods with their shortcuts (called
 * types). In particular, if a formatting method is named <code>formatXyz</code>, then its shortcut method is
 * <code>xyz</code>
 ...
 * <li>ntext: the {@link formatNtext} method will be called to format the attribute value as a HTML-encoded plain text
 * with newlines converted as the HTML &lt;br /&gt; or &lt;p&gt;&lt;/p&gt; tags.</li>
 ...
 * <li>datetime: the {@link formatDatetime} method will be called to format the attribute value as a date with
 * time.</li>
 * <li>boolean: the {@link formatBoolean} method will be called to format the attribute value as a boolean
 * display.</li>
 ...
 * <li>image: the {@link formatImage} method will be called to format the attribute value as an image tag where the
 * attribute value is the image URL.</li>
 * <li>url: the {@link formatUrl} method will be called to format the attribute value as a hyperlink where the
 * attribute value is the URL.</li>
 * <li>size: the {@link formatSize} method will be called to format the attribute value, interpreted as a number of
 * bytes, as a size in human readable form.</li>
 * </ul>
...
class CFormatter extends CApplicationComponent
{
    ...
    /**
     * @var array the format used to format size (bytes). Three elements may be specified: "base", "decimals" and
     *      "decimalSeparator". They correspond to the base at which a kilobyte is calculated (1000 or 1024 bytes per
     *      kilobyte, defaults to 1024), the number of digits after the decimal point (defaults to 2) and the character
     *      displayed as the decimal point.
