...
class CFileHelper
{
     ...
     *                        <ul>
     *                        <li>fileTypes: array, list of file name suffix (without dot). Only files with these
     *                        suffixes will be copied.</li>
     *                        <li>exclude: array, list of directory and file exclusions. Each exclusion can be either a
     *                        name or a path. If a file or directory name or path matches the exclusion, it will not be
     *                        copied. For example, an exclusion of
     *                        '.svn' will exclude all files and directories whose name is '.svn'. And an exclusion of
     *                        '/a/b' will exclude file or directory '$src/a/b'. Note, that '/' should be used as
     ...
     *                        </li>
     *                        <li>newDirMode - the permission to be set for newly copied directories (defaults to
     *                        0777);</li>
     *                        <li>newFileMode - the permission to be set for newly copied files (defaults to the
     *                        current environment setting).</li>
     *                        </ul>
     */
     ...
     *                          <ul>
     *                          <li>traverseSymlinks: boolean, whether symlinks to the directories should be traversed
     *                          too. Defaults to `false`, meaning that the content of the symlinked directory would not
     *                          be deleted. Only symlink would be removed in that default case.</li>
     *                          </ul>
     ...
     *                        </li>
     *                        <li>absolutePaths: boolean, whether to return absolute paths or relative ones, defaults
     *                        to true.</li>
     *                        </ul>
     ...
     *                           If a file or directory name or path matches the exclusion, it will not be copied. For
     *                           example, an exclusion of
     *                           '.svn' will exclude all files and directories whose name is '.svn'. And an exclusion
     *                           of '/a/b' will exclude file or directory '$src/a/b'. Note, that '/' should be used as
     *                           separator regardless of the value of the DIRECTORY_SEPARATOR constant.
     ...
     *                           newFileMode - the permission to be set for newly copied files (defaults to the current
     *                           environment setting).
     */
     ...
     * @param string  $base          the path relative to the original source directory
     * @param array   $fileTypes     list of file name suffix (without dot). Only files with these suffixes will be
     *                               returned.
     * @param array   $exclude       list of directory and file exclusions. Each exclusion can be either a name or a
     *                               path. If a file or directory name or path matches the exclusion, it will not be
     *                               copied. For example, an exclusion of
     ...
     *                               should be used as separator regardless of the value of the DIRECTORY_SEPARATOR
     *                               constant.
     * @param integer $level         recursion depth. It defaults to -1.
     *                               Level -1 means searching for all directories and files under the directory;
     *                               Level 0 means searching for only the files DIRECTLY under the directory;
     ...
     * @param array   $exclude   list of directory and file exclusions. Each exclusion can be either a name or a path.
     *                           If a file or directory name or path matches the exclusion, false will be returned. For
     *                           example, an exclusion of
     *                           '.svn' will return false for all files and directories whose name is '.svn'. And an
     *                           exclusion of '/a/b' will return false for file or directory '$src/a/b'. Note, that '/'
     *                           should be used as separator regardless of the value of the DIRECTORY_SEPARATOR
     *                           constant.
     ...
     *                                http://php.net/manual/en/function.finfo-open.php finfo_open}. Magic file format
     *                                described in {@link http://linux.die.net/man/5/magic man 5 magic}, note that this
     *                                file does not contain a standard PHP array as you might suppose. Specified magic
     *                                file will be used only when fileinfo PHP extension is available. This parameter
     ...
     *                                based on finfo and mime_content_type. Defaults to true. This parameter has been
     *                                available since version 1.1.4.
