 ...
 * <li>hash (#): optional digit. This is mainly used to specify the location of decimal point and grouping
 * separators.</li>
 * <li>currency (¤): the currency placeholder. It will be replaced with the localized currency symbol.</li>
 * <li>percentage (%): the percentage mark. If appearing, the number will be multiplied by 100 before being
 * formatted.</li>
 * <li>permillage (‰): the permillage mark. If appearing, the number will be multiplied by 1000 before being
 * formatted.</li>
...
class CNumberFormatter extends CComponent
{
     ...
     *                         represents the Euro currency. The currency placeholder in the pattern will be replaced
     *                         with the currency symbol. If null, no replacement will be done.
