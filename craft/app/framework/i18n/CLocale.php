 ...
 * @property array            $weekDayNames     The weekday names indexed by weekday values (0-6, 0 means Sunday, 1
 *           Monday, etc.).
 ...
 * @property string           $orientation      The character orientation, which is either 'ltr' (left-to-right) or
 *           'rtl' (right-to-left).
...
class CLocale extends CComponent
{
    ...
    /**
     * @param string $currency 3-letter ISO 4217 code. For example, the code "USD" represents the US Dollar and "EUR"
    ...
    /**
     * @param string $id Unicode language identifier from IETF BCP 47. For example, the code "en_US" represents U.S.
     *                   English and "en_GB" represents British English.
    ...
    /**
     * @param string $id Unicode script identifier from IETF BCP 47. For example, the code "en_US" represents U.S.
     *                   English and "en_GB" represents British English.
    ...
    /**
     * @param string $id Unicode territory identifier from IETF BCP 47. For example, the code "en_US" represents U.S.
     *                   English and "en_GB" represents British English.
