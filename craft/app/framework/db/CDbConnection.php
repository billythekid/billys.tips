...
class CDbConnection extends CApplicationComponent
{
     ...
     *                     CDbCommand::__construct} for more details about how to pass an array as the query. If this
     *                     parameter is not given, you will have to call query builder methods of {@link CDbCommand} to
     *                     build the DB query.
