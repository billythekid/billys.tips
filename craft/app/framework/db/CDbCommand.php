...
class CDbCommand extends CComponent
{
     ...
     *                                  {@link union}. Please refer to the setter of each of these properties for
     *                                  details about valid property values. This feature has been available since
     *                                  version 1.1.6. Since 1.1.7 it is possible to use a specific mode of data
     *                                  fetching by setting
     *                                  {@link setFetchMode FetchMode}. See {@link
     *                                  http://www.php.net/manual/en/function.PDOStatement-setFetchMode.php} for more
     *                                  details.
     */
     ...
     *                                 multiple columns, separate them with commas or pass as an array of column names.
     ...
     *                                 columns, separate them with commas or pass as an array of column names.
     * @param string       $delete     the ON DELETE option. Most DBMS support these options: RESTRICT, CASCADE, NO
     *                                 ACTION, SET DEFAULT, SET NULL
     * @param string       $update     the ON UPDATE option. Most DBMS support these options: RESTRICT, CASCADE, NO
     *                                 ACTION, SET DEFAULT, SET NULL
     * @return integer number of rows affected by the execution.
     * @since 1.1.6
     */
     ...
     * @param string       $table   the table that the new index will be created for. The table name will be properly
     *                              quoted by the method.
     * @param string|array $columns the column(s) that should be included in the index. If there are multiple columns,
     *                              please separate them by commas or pass as an array of column names. Each column
     *                              name will be properly quoted by the method, unless a parenthesis is found in the
     *                              name.
     ...
     *
     * @param string       $name    the name of the primary key constraint to be created. The name will be properly
     *                              quoted by the method.
     * @param string       $table   the table who will be inheriting the primary key. The name will be properly quoted
     *                              by the method.
