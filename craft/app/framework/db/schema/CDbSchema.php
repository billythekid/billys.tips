...
abstract class CDbSchema extends CComponent
{
     ...
     * physical types):
     * <ul>
     * <li>pk and bigpk: an auto-incremental primary key type, will be converted into "int(11) NOT NULL AUTO_INCREMENT
     * PRIMARY KEY" or "bigint(20) NOT NULL AUTO_INCREMENT PRIMARY KEY"</li>
