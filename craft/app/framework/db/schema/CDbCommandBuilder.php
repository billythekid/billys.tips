...
class CDbCommandBuilder extends CComponent
{
     ...
     * @param array      $values  values for binding (integer-indexed array for question mark placeholders,
     *                            string-indexed array for named placeholders)
     */
     ...
     *                          If an array, it is treated as the initial values for constructing a {@link
     *                          CDbCriteria};
