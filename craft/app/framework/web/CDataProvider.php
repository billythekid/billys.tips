 ...
 *
 * @property string      $id             The unique ID that uniquely identifies the data provider among all data
 *           providers.
 ...
 * @property array       $keys           The list of key values corresponding to {@link data}. Each data item in {@link
 *           data} is uniquely identified by the corresponding key value in this array.
...
abstract class CDataProvider extends CComponent implements IDataProvider
{
     ...
     * or an array used to configure the pagination object. If this is false, it means the pagination should be
     * disabled. You can configure this property same way as a component:
     * <pre>
     * array(
     *     'class' => 'MyPagination',
     *     'pageSize' => 20,
