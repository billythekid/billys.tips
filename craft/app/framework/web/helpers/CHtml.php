...
class CHtml
{
     ...
     *
     * @param string $text        link body. It will NOT be HTML-encoded. Therefore you can pass in HTML code such as
     *                            an image tag.
     ...
     * @param string $text        link body. It will NOT be HTML-encoded. Therefore you can pass in HTML code such as
     *                            an image tag.
     * @param string $email       email address. If this is empty, the first parameter (link body) will be treated as
     *                            the email address.
     * @param array  $htmlOptions additional HTML attributes. Besides normal HTML attributes, a few special
     *                            attributes are also recognized (see {@link clientChange} and {@link tag} for more
     *                            details.)
     ...
     * @param array   $htmlOptions additional HTML attributes. Besides normal HTML attributes, a few special
     *                             attributes are also recognized (see {@link clientChange} and {@link tag} for more
     *                             details.) Since version 1.1.2, a special option named 'uncheckValue' is available
     *                             that can be used to specify the value returned when the radio button is not checked.
     *                             When set, a hidden field is rendered so that when the radio button is not checked,
     *                             we can still obtain the posted uncheck value. If 'uncheckValue' is not set or set to
     *                             NULL, the hidden field will not be rendered.
     ...
     *                             attributes are also recognized (see {@link clientChange} and {@link tag} for more
     *                             details.) Since version 1.1.2, a special option named 'uncheckValue' is available
     *                             that can be used to specify the value returned when the checkbox is not checked.
     *                             When set, a hidden field is rendered so that when the checkbox is not checked, we
     *                             can still obtain the posted uncheck value. If 'uncheckValue' is not set or set to
     *                             NULL, the hidden field will not be rendered.
     ...
     *                            Please refer to {@link listOptions} on how this data is used to generate the list
     *                            options. Note, the values and labels will be automatically HTML-encoded by this
     *                            method.
     * @param array  $htmlOptions additional HTML attributes. Besides normal HTML attributes, a few special
     ...
     *                            <li>prompt: string, specifies the prompt text shown as the first list option. Its
     *                            value is empty. Note, the prompt text will NOT be HTML-encoded.</li>
     *                            <li>empty: string, specifies the text corresponding to empty selection. Its value is
     *                            empty. The 'empty' option can also be an array of value-label pairs. Each pair will
     *                            be used to render a list option at the beginning. Note, the text label will NOT be
     *                            HTML-encoded.</li>
     ...
     *                            </li>
     *                            </ul>
     *                            Since 1.1.13, a special option named 'unselectValue' is available. It can be used to
     *                            set the value that will be returned when no option is selected in multiple mode. When
     *                            set, a hidden field is rendered so that if no option is selected in multiple mode, we
     *                            can still obtain the posted unselect value. If 'unselectValue' is not set or set to
     *                            NULL, the hidden field will not be rendered.
     ...
     *
     * @param string $name        the input name
     * @param mixed  $select      the selected value(s). This can be either a string for single selection or an array
     ...
     * @param array  $htmlOptions additional HTML attributes. Besides normal HTML attributes, a few special
     *                            attributes are also recognized. See {@link clientChange} and {@link tag} for more
     *                            details. In addition, the following options are also supported specifically for list
     *                            box:
     *                            <ul>
     *                            <li>encode: boolean, specifies whether to encode the values. Defaults to true.</li>
     *                            <li>prompt: string, specifies the prompt text shown as the first list option. Its
     ...
     *                            {beginLabel} will be replaced by &lt;label&gt; with labelOptions, {labelTitle} will
     *                            be replaced by the corresponding check box label title and {endLabel} will be
     *                            replaced by &lt;/label&gt;</li>
     *                            <li>separator: string, specifies the string that separates the generated check
     *                            boxes.</li>
     ...
     *                            <li>baseID: string, specifies the base ID prefix to be used for checkboxes in the
     *                            list. This option is available since version 1.1.13.</li>
     *                            </ul>
...
EOD;
     ...
     *                            to "{input} {label}", where "{input}" will be replaced by the generated
     *                            radio button input tag while "{label}" will be replaced by the corresponding radio
     *                            button label,
     *                            {beginLabel} will be replaced by &lt;label&gt; with labelOptions, {labelTitle} will
     *                            be replaced by the corresponding radio button label title and {endLabel} will be
     *                            replaced by &lt;/label&gt;</li>
     *                            <li>separator: string, specifies the string that separates the generated radio
     *                            buttons. Defaults to new line (<br/>).</li>
     *                            <li>labelOptions: array, specifies the additional HTML attributes to be rendered
     *                            for every label tag in the list.</li>
     *                            <li>container: string, specifies the radio buttons enclosing tag. Defaults to 'span'.
     *                            If the value is an empty string, no enclosing tag will be generated</li>
     *                            <li>baseID: string, specifies the base ID prefix to be used for radio buttons in the
     *                            list. This option is available since version 1.1.13.</li>
     *                            <li>empty: string, specifies the text corresponding to empty selection. Its value is
     *                            empty. The 'empty' option can also be an array of value-label pairs. Each pair will
     *                            be used to render a radio button at the beginning. Note, the text label will NOT be
     *                            HTML-encoded. This option is available since version 1.1.14.</li>
     *                            </ul>
     ...
     * @param mixed  $url         the URL for the AJAX request. If empty, it is assumed to be the current URL. See
     *                            {@link normalizeUrl} for more details.
     ...
     * @param array  $htmlOptions additional HTML attributes. Besides normal HTML attributes, a few special
     *                            attributes are also recognized (see {@link clientChange} and {@link tag} for more
     *                            details.) A special option named 'uncheckValue' is available that can be used to
     *                            specify the value returned when the radio button is not checked. By default, this
     *                            value is '0'. Internally, a hidden field is rendered so that when the radio button is
     *                            not checked, we can still obtain the posted uncheck value. If 'uncheckValue' is set
     *                            as NULL, the hidden field will not be rendered.
     * @return string the generated radio button
     * @see clientChange
     * @see activeInputField
     */
     ...
     *                            attributes are also recognized (see {@link clientChange} and {@link tag} for more
     *                            details.) A special option named 'uncheckValue' is available that can be used to
     *                            specify the value returned when the checkbox is not checked. By default, this value
     *                            is '0'. Internally, a hidden field is rendered so that when the checkbox is not
     *                            checked, we can still obtain the posted uncheck value. If 'uncheckValue' is set as
     *                            NULL, the hidden field will not be rendered.
     * @return string the generated check box
     * @see clientChange
     * @see activeInputField
     ...
     *                            <li>template: string, specifies how each checkbox is rendered. Defaults
     *                            to "{input} {label}", where "{input}" will be replaced by the generated
     *                            check box input tag while "{label}" will be replaced by the corresponding check box
     *                            label.</li>
     *                            <li>separator: string, specifies the string that separates the generated check
     *                            boxes.</li>
     *                            <li>checkAll: string, specifies the label for the "check all" checkbox.
     ...
     *                            or is false, the 'check all' checkbox will be displayed at the beginning of
     *                            the checkbox list.</li>
     *                            <li>encode: boolean, specifies whether to encode HTML-encode tag attributes and
     ...
     *                            list. This option is available since version 1.1.13.</li>
     *                            </ul>
     *                            Since 1.1.7, a special option named 'uncheckValue' is available. It can be used to
     *                            set the value that will be returned when the checkbox is not checked. By default,
     *                            this value is ''. Internally, a hidden field is rendered so when the checkbox is not
     *                            checked, we can still obtain the value. If 'uncheckValue' is set to NULL, there will
     ...
     *                            HTML-encoded. This option is available since version 1.1.14.</li>
     *                            </ul>
     *                            Since version 1.1.7, a special option named 'uncheckValue' is available that can be
     *                            used to specify the value returned when the radio button is not checked. By default,
     *                            this value is ''. Internally, a hidden field is rendered so that when the radio
     ...
     *                          can also be an array of associative arrays (e.g. results of {@link
     *                          CDbCommand::queryAll}).
     ...
     * @param mixed $groupField the attribute name or anonymous function (PHP 5.3+) for list option group names. If
     ...
     *
     * @param mixed $selection   the selected value(s). This can be either a string for single selection or an array
     *                           for multiple selections.
     ...
     *                           value is empty. Note, the prompt text will NOT be HTML-encoded.</li>
     *                           <li>empty: string, specifies the text corresponding to empty selection. Its value is
     *                           empty. The 'empty' option can also be an array of value-label pairs. Each pair will be
     *                           used to render a list option at the beginning. Note, the text label will NOT be
     *                           HTML-encoded.</li>
     *                           <li>options: array, specifies additional attributes for each OPTION tag.
     *                           The array keys must be the option values, and the array values are the extra
     *                           OPTION tag attributes in the name-value pairs. For example,
     ...
     *                           the property named by the key option of the objects will be treated as the actual
     *                           selection value. This option defaults to 'primaryKey', meaning using the 'primaryKey'
     *                           property value of the objects in the selection. This option has been available since
     *                           version 1.1.3.</li>
     *                           </ul>
