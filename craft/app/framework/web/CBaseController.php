...
abstract class CBaseController extends CComponent
{
     ...
     *                               and return the output generated by the widget. If false, the output will be
     *                               directly sent for display and the widget object will be returned. This parameter
     *                               is available since version 1.1.2.
     * @return mixed the widget instance when $captureOutput is false, or the widget output when $captureOutput is
     *               true.
     */
     ...
     *                    any module, the default layout refers to the application's {@link CWebApplication::layout
     *                    default layout}; If the controller belongs to a module, the default layout refers to the
     *                    module's
