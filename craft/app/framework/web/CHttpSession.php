 ...
 * @property float                $gCProbability           The probability (percentage) that the gc (garbage
 *           collection) process is started on every session initialization, defaults to 1 meaning 1% chance.
 * @property boolean              $useTransparentSessionID Whether transparent sid support is enabled or not, defaults
 *           to false.
 * @property integer              $timeout                 The number of seconds after which data will be seen as
...
{
    /**
     * @var boolean whether the session should be automatically started when the session application component is
    ...
    /**
     * @param string $value the session name for the current session, must be an alphanumeric string, defaults to
     *                      PHPSESSID
     */
    ...
    /**
     * @return integer the number of seconds after which data will be seen as 'garbage' and cleaned up, defaults to
     *                 1440 seconds.
     */
