...
class CSort extends CComponent
{
     ...
     * then the corresponding virtual attribute definition is returned. Starting from version 1.1.3, if {@link
     * attributes} contains a star ('*') element, the name will also be used to match against all model
     * attributes.</li>
