...
class CPagination extends CComponent
{
     ...
     * it means you must have knowledge about the total number of data items when you want to access {@link
     * currentPage}. This is fine for SQL-based queries, but may not be feasible for other kinds of queries (e.g.
     * MongoDB). In those cases, you may set this property to be false to skip the validation (you may need to validate
     * yourself then). Defaults to true.
     * @since 1.1.4
     */
