...
class CClientScript extends CApplicationComponent
{
     ...
     *                             <ul>
     *                             <li>CClientScript::POS_HEAD : the script is inserted in the head section right
     *                             before the title element.</li>
     ...
     *                             </ul>
     * @param array   $htmlOptions additional HTML attributes
     *                             Note: HTML attributes are not allowed for script positions "CClientScript::POS_LOAD"
     *                             and "CClientScript::POS_READY".
     * @return static the CClientScript object itself (to support method chaining, available since version 1.1.5).
     */
    ...
    /**
     * Registers a link tag that will be inserted in the head section (right before the title element) of the resulting
     * page.
     *
