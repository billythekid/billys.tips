...
class CUploadedFile extends CComponent
{
     ...
     * @param string $attribute the attribute name. For tabular file uploading, this can be in the format of
     *                          "[$i]attributeName", where $i stands for an integer index.
    ...
    /**
     * Returns an instance of the specified uploaded file.
     * The name can be a plain string or a string like an array element (e.g. 'Post[imageFile]', or
     * 'Post[0][imageFile]').
     *
     ...
     *                                In some exceptional cases such as not enough permissions to write to the path
     *                                specified PHP warning is triggered.
     */
