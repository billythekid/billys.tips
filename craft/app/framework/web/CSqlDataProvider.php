...
class CSqlDataProvider extends CDataProvider
{
     ...
     * Constructor.
     *
     * @param string|CDbCommand $sql    the SQL statement to be used for fetching data rows. Since version 1.1.13 this
     *                                  can also be an instance of {@link CDbCommand}.
     * @param array             $config configuration (name=>value) to be applied as the initial property values of
     *                                  this class.
     */
