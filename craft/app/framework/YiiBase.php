...
class YiiBase
{
     ...
     *                      Please make sure you specify the {@link CApplication::basePath basePath} property in the
     *                      configuration, which should point to the directory containing all application logic,
     *                      template and data. If not, the directory will be defaulted to 'protected'.
     ...
     * <code>application.components.GoogleMap</code>. The difference is that the former class is using qualified name,
     * while the latter unqualified. Note, importing a class in namespace format requires that the namespace
     * corresponds to a valid path alias once backslash characters are replaced with dot characters. For example, the
     * namespace <code>application\components</code> must correspond to a valid path alias
     * <code>application.components</code>.
     *
     * @param string  $alias        path alias to be imported
     * @param boolean $forceInclude whether to include the class file immediately. If false, the class file
     *                              will be included only when the class is being used. This parameter is used only
     *                              when
     ...
     * @param string $language the target language. If null (default), the {@link CApplication::getLanguage application
     ...
     *                           Be careful using this option as it will disable {@link enableIncludePath autoloading
     *                           via include path} when set to true. After this the Yii autoloader can not rely on
     *                           loading classes via simple include anymore and you have to {@link import} all classes
     *                           explicitly.
     */
