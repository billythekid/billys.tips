...
test("Craft.getUrl()", function () {
    ...
    equal(Craft.getUrl("http://example.com/"),
        "http://example.com/");
    ...
    equal(Craft.getSiteUrl("about", "foo=1&bar=1"), "http://craft.dev/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about", "?foo=1&bar=1&"), "http://craft.dev/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1",
        "bar=1"), "http://craft.dev/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1", {bar: 1}), "http://craft.dev/about?foo=1&bar=1");
    ...
    equal(Craft.getResourceUrl("", "foo=1&bar=1"), "http://craft.dev/admin/resources?foo=1&bar=1");
    equal(Craft.getResourceUrl("", "?foo=1&bar=1&"), "http://craft.dev/admin/resources?foo=1&bar=1");
    equal(Craft.getResourceUrl("",
        {foo: 1, "#": "bar"}), "http://craft.dev/admin/resources?foo=1#bar");
    equal(Craft.getResourceUrl("about", {foo: 1, bar: 1}), "http://craft.dev/admin/resources/about?foo=1&bar=1");
    equal(Craft.getResourceUrl("about", "foo=1&bar=1"), "http://craft.dev/admin/resources/about?foo=1&bar=1");
    equal(Craft.getResourceUrl("about", "?foo=1&bar=1&"), "http://craft.dev/admin/resources/about?foo=1&bar=1");
    equal(Craft.getResourceUrl("about?foo=1", "bar=1"), "http://craft.dev/admin/resources/about?foo=1&bar=1");
    equal(Craft.getResourceUrl("about?foo=1",
        {bar: 1}), "http://craft.dev/admin/resources/about?foo=1&bar=1");
    ...
    equal(Craft.getActionUrl("", "foo=1&bar=1"), "http://craft.dev/index.php/admin/actions?foo=1&bar=1");
    equal(Craft.getActionUrl("", "?foo=1&bar=1&"), "http://craft.dev/index.php/admin/actions?foo=1&bar=1");
    equal(Craft.getActionUrl("", {
        foo: 1,
        "#": "bar"
    }), "http://craft.dev/index.php/admin/actions?foo=1#bar");
    equal(Craft.getActionUrl("about", {foo: 1, bar: 1}), "http://craft.dev/index.php/admin/actions/about?foo=1&bar=1");
    equal(Craft.getActionUrl("about", "foo=1&bar=1"), "http://craft.dev/index.php/admin/actions/about?foo=1&bar=1");
    equal(Craft.getActionUrl("about", "?foo=1&bar=1&"), "http://craft.dev/index.php/admin/actions/about?foo=1&bar=1");
    equal(Craft.getActionUrl("about?foo=1", "bar=1"), "http://craft.dev/index.php/admin/actions/about?foo=1&bar=1");
    equal(Craft.getActionUrl("about?foo=1", {bar: 1}), "http://craft.dev/index.php/admin/actions/about?foo=1&bar=1");
    equal(Craft.getActionUrl("about", {
        foo: 1,
        "#": "bar"
    }), "http://craft.dev/index.php/admin/actions/about?foo=1#bar");
    ...
    equal(Craft.getUrl("about", {foo: 1, bar: 1}),
        "http://craft.dev/index.php/admin/about?foo=1&bar=1");
    ...
    equal(Craft.getSiteUrl("about", "foo=1&bar=1"), "http://craft.dev/index.php/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about",
        "?foo=1&bar=1&"), "http://craft.dev/index.php/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1", "bar=1"), "http://craft.dev/index.php/about?foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1", {bar: 1}), "http://craft.dev/index.php/about?foo=1&bar=1");
    ...
    equal(Craft.getResourceUrl("about", {
        foo: 1,
        bar: 1
    }), "http://craft.dev/index.php/admin/resources/about?foo=1&bar=1");
    ...
    equal(Craft.getResourceUrl("about", {
        foo: 1,
        "#": "bar"
    }), "http://craft.dev/index.php/admin/resources/about?foo=1#bar");
    equal(Craft.getActionUrl("", {foo: 1, bar: 1}), "http://craft.dev/index.php/admin/actions?foo=1&bar=1");
    equal(Craft.getActionUrl("", "foo=1&bar=1"), "http://craft.dev/index.php/admin/actions?foo=1&bar=1");
    equal(Craft.getActionUrl("", "?foo=1&bar=1&"), "http://craft.dev/index.php/admin/actions?foo=1&bar=1");
    ...
    equal(Craft.getUrl("about",
        {foo: 1, bar: 1}), "http://craft.dev/?p=admin/about&foo=1&bar=1");
    ...
    equal(Craft.getSiteUrl("about", "foo=1&bar=1"), "http://craft.dev/?p=about&foo=1&bar=1");
    equal(Craft.getSiteUrl("about",
        "?foo=1&bar=1&"), "http://craft.dev/?p=about&foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1", "bar=1"), "http://craft.dev/?p=about&foo=1&bar=1");
    equal(Craft.getSiteUrl("about?foo=1", {bar: 1}), "http://craft.dev/?p=about&foo=1&bar=1");
    ...
    equal(Craft.getActionUrl("about", "foo=1&bar=1"), "http://craft.dev/?p=admin/actions/about&foo=1&bar=1");
    equal(Craft.getActionUrl("about", "?foo=1&bar=1&"), "http://craft.dev/?p=admin/actions/about&foo=1&bar=1");
    equal(Craft.getActionUrl("about?foo=1",
        "bar=1"), "http://craft.dev/?p=admin/actions/about&foo=1&bar=1");
    equal(Craft.getActionUrl("about?foo=1", {bar: 1}), "http://craft.dev/?p=admin/actions/about&foo=1&bar=1");
