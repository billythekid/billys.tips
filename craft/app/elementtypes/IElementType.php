...
interface IElementType extends IComponentType
{
     ...
     *   (Optional)
     * - **`data`** – An array of `data-X` attributes that should be set on the source’s `<a>` tag in the source
     * list’s,
     ...
     * - **`defaultSort`** – A string identifying the sort attribute that should be selected by default, or an array
     * where the first value identifies the sort attribute, and the second determines which direction to sort by.
     * (Optional)
     ...
     * @param string             $handle         The property handle used to identify which target elements should be
     *                                           included in the map
