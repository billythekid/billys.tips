...
class Craft extends \Yii
{
     ...
     *
     * @deprecated Deprecated in 1.3. Use {@link AppBehavior::enableMaintenanceMode()
     *             `craft()->enableMaintenanceMode()`} instead.
     * @return bool
     */
     ...
     *
     * @deprecated Deprecated in 1.3. Use {@link AppBehavior::disableMaintenanceMode()
     *             `craft()->disableMaintenanceMode()`} instead.
     * @return bool
     */
     ...
     * @param array       $variables An associative array of key => value pairs to be applied to the message using
     *                               `strtr`.
     ...
     * @param string|null $language  The target language. If set to null (default), craft()->getLanguage() will be
     *                               used.
